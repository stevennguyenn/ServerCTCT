<?php
	...
	$query = "SELECT * FROM question_vatly1 WHERE test_code = (SELECT test_code FROM test where test_status = 1 AND test_code LIKE 'VL1\_%' LIMIT 1) AND test_code NOT IN (SELECT test_code from studenttest where id = '$id')";
